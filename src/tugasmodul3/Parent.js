...
class Parent extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        alert(`Component Updates! State angka sebelumnya Child1: ${prevState.komponen1} -- State angka sebelumnya Child2: ${prevState.komponen2}`)
    }
    ...
    render() {
        return (
            <div>
                ...
                <button onClick={this.ubahkomponen1}>{this.state.komponen1 ? 'SEMBUNYIKAN' : 'TAMPILKAN'} child 1!</button>
                <br/>
